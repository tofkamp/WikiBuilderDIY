//Added a few extra functionalities to the script:
//Alignment Horizontal/Vertical will choose the direction of the workflow
//FitType FixedBoth will fix the number of rows and columns and even allow overflow in order to use scrollbar and masks.
